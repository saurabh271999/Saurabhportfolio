...
const About = () => {
  return (
    <div className="bg-[#131C2F] flex items-center justify-center flex-col">
      <h1 className="text-white text-5xl font-bold mt-10 border-b-2 inline-block border-blue-500">About ME</h1>
      <p className="text-white text-center mt-10 text-2xl">
        Full-stack developer with 1+ years of experience in building scalable <br />
